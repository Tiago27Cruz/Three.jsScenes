...
class MyApp  {
     ...
     */
    onMouseMove(event){
        if(this.contents !== null && this.contents !== undefined && !this.contents.keys.has('mouseMove')){
            this.contents.mouse_pos.x = (event.clientX/window.innerWidth)*2-1;
            this.contents.mouse_pos.y = -(event.clientY/window.innerHeight)*2+1;
            this.contents.keys.add('mouseMove');
        }
    }
    ...
    initCameras() {
        ...
        perspective1.position.set(60,70,60)
        this.cameras['Perspective'] = perspective1

        // Create a basic perspective camera in a different initial pov
        const perspective2 = new THREE.PerspectiveCamera(75, aspect, 0.1, 1000)
        perspective2.position.set(-60,40,-70)
        ...
        orthoTop.position.set(0, this.frustumSize/6, 0) 
        ...
        // create a bottom(back) view orthographic camera
